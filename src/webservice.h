...
/*
brief		:实体状态通知。数据量较多，所以新增此消息，Entity_Nofitication也有相同的功能，但数据冗余较多；
param in	:
param in	:
param out	:response
*/
...
brief		:踢出群组
param in	:group_id
param in	:account_id//account_id必须是群组的成员,如果没有指定account_id则清空群组的成员，否则把指定的成员踢出.
param out	:
*/
...
/*
brief		:订阅信息,对于不在线的设备，系统会推送最后一次的位置信息
...
/*
brief		:调度台订阅了终端的GPS信息后，终端有位置信息上报时,通知给调度台
param in	:
param in	:  
param out	:response
*/
